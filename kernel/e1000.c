...
void e1000_init(uint32 *xregs)
{
  ...
  regs[E1000_TDBAL] = (uint64)tx_ring; // indicate start of ring buffer
  if (sizeof(tx_ring) % 128 != 0)      // chapter 3.4
    panic("e1000");
  ...
  regs[E1000_TCTL] = E1000_TCTL_EN |                  // enable
                     ...
                     (0x40 << E1000_TCTL_COLD_SHIFT); // half duplex
